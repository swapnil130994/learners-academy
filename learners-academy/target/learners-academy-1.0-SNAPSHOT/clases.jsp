...
<div class="container">
    ...
    <table class="striped card-panel highlight" id="myTable">
        ...
        <tbody>
        <%
            List<Clss> clasesList = (List<Clss>) request.getAttribute("classesList");

            // Paint the rows of the clase table
            for (Clss clase : clasesList) {
                out.println("");
...
<script>
    async function fOpenEdit(pId) {
        ...
        fetch("http://localhost:8080/learners-academy/clase-controller", {
            headers: {
