 ...
 * Generated at: 2023-05-27 12:42:18 UTC
...
public final class clases_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("        <h2 class=\"header\">Classes</h2>\r\n");
      ...
      out.write("                        <label for=\"className\" class=\"active\">Class Name</label>\r\n");
      out.write("                </div>\r\n");
      out.write("            </div>\r\n");
      ...
      out.write("        console.log(\"----> about to saveOneClass: \" + oFormEntries.toString());\r\n");
      out.write("        await saveOneClass(oFormEntries);\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      ...
      out.write("        document.getElementById(\"action\").value = \"updateOneClass\";\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("        fetch(\"http://localhost:8080/learners-academy/clase-controller\", {\r\n");
      out.write("            headers: {\r\n");
      out.write("                'Accept': 'application/json',\r\n");
      out.write("                'Content-Type': 'application/json'\r\n");
      out.write("            },\r\n");
      out.write("            method: \"POST\",\r\n");
      out.write("            body: JSON.stringify({action: \"fetchOneClass\", classId: pId})\r\n");
      out.write("\r\n");
      ...
      out.write("\r\n");
      out.write("        // Set the action\r\n");
      out.write("        document.getElementById(\"action\").value = \"deleteOneClass\";\r\n");
      out.write("\r\n");
      out.write("        // Trigger the Modal to open\r\n");
      out.write("        document.getElementById('modalLink').click();\r\n");
      out.write("        document.getElementById(\"preloader\").style.display = \"flex\"; // this centers the spinner in the modal window\r\n");
      ...
      out.write("                document.querySelector(\"#classId\").disabled  = true;\r\n");
      out.write("                document.querySelector(\"#className\").disabled  = true;\r\n");
      out.write("\r\n");
      out.write("                //Setting the Id to delete\r\n");
      out.write("                document.querySelector(\"#deleteClassId\").value = jsonObject.classId;\r\n");
      out.write("                await delay(1000);\r\n");
      out.write("                document.getElementById(\"preloader\").style.display = \"none\";\r\n");
      out.write("\r\n");
      out.write("            } catch (e) {\r\n");
      ...
      out.write("\r\n");
      out.write("        // Set the action\r\n");
      out.write("        document.getElementById(\"action\").value = \"saveNewClass\";\r\n");
      out.write("\r\n");
      out.write("        //Clean and enabling the controls\r\n");
      out.write("        document.querySelector(\"#classId\").disabled  = false;\r\n");
      out.write("        document.querySelector(\"#className\").disabled  = false;\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    //ACTION: updateOneClass or saveNewClass\r\n");
      out.write("    function saveOneClass(oFormEntries) {\r\n");
      out.write("        console.log(\" -----> saveOneClass:\" + \"\");\r\n");
      ...
      out.write("                console.log(\" -------> clasejsp fetch: \" + jsonReturnString);\r\n");
      out.write("                try {\r\n");
      out.write("\r\n");
      ...
      out.write("                    M.toast({\r\n");
      out.write("                        html:\r\n");
      out.write("                            jsonObject.code === 0 ? jsonObject.message : \"<table><tr><td class=\\\"center-align\\\">Class NOT UPDATED</td></tr><tr><td>CODE: \" + jsonObject.code +\r\n");
      out.write("                                \" - \" +\r\n");
      ...
      out.write("                } catch (e) {\r\n");
      out.write("                    // On Error\r\n");
      out.write("                    console.log(\"ERROR: fetchClass/querySelector\" + e);\r\n");
      out.write("                }\r\n");
      out.write("\r\n");
      out.write("            });\r\n");
      out.write("        } catch (e) {\r\n");
      ...
      out.write("\r\n");
      out.write("    //ACTION: updateOneClass or saveNewClass\r\n");
      out.write("    function deleteOneClass(oFormEntries) {\r\n");
      out.write("        console.log(\" -----> deleteOneClass:\" + \"\");\r\n");
      out.write("        console.log(\" -----> action: \" + document.getElementById('action').value);\r\n");
      out.write("        try {\r\n");
      out.write("            fetch(\"http://localhost:8080/learners-academy/clase-controller\", {\r\n");
      out.write("                headers: {\r\n");
